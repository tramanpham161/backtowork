      ...
      <header className="bg-white border-b border-slate-200/60 py-4 px-4 sticky top-0 z-50 backdrop-blur-md bg-white/90">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-lg font-bold tracking-tight text-slate-800">BackToWork</h1>
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-none mt-0.5">Planner</p>
            </div>
          </div>
          <div className="hidden sm:flex items-center gap-6 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
            <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-blue-200"></span> 2026 Ready</span>
            <span className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-blue-200"></span> 30-Hour Policy</span>
          </div>
        </div>
      </header>
              ...
              <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
                ...
                <div className="py-8 px-6 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-5">
                  ...
                  <div className="flex justify-between text-[10px] text-slate-300 font-bold uppercase tracking-wider">
                    <span>Local average (£7-9)</span>
                    <span>London/premium (£14+)</span>
                  </div>
                </div>
            ...
            <div className="flex justify-center">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="tracking-tight font-medium">Check your childcare funding eligibility and cost estimates on <strong>Childcare Checker UK</strong></span>
                </div>
                <ExternalLink size={16} className="text-slate-300 group-hover:text-slate-600 transition-colors" />
              </a>
            </div>

            {/* Always visible useful links */}
            <UsefulLinks />
          </div>
